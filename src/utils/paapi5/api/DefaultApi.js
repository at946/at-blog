...
(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		root.ProductAdvertisingAPIv1.DefaultApi = factory(
			root.ProductAdvertisingAPIv1.ApiClient,
			root.ProductAdvertisingAPIv1.GetBrowseNodesRequest,
			root.ProductAdvertisingAPIv1.GetBrowseNodesResponse,
			root.ProductAdvertisingAPIv1.GetItemsRequest,
			root.ProductAdvertisingAPIv1.GetItemsResponse,
			root.ProductAdvertisingAPIv1.GetVariationsRequest,
			root.ProductAdvertisingAPIv1.GetVariationsResponse,
			root.ProductAdvertisingAPIv1.ProductAdvertisingAPIClientException,
			root.ProductAdvertisingAPIv1.ProductAdvertisingAPIServiceException,
			root.ProductAdvertisingAPIv1.SearchItemsRequest,
			root.ProductAdvertisingAPIv1.SearchItemsResponse,
		);
	}
})(
	this,
	function (
		...
		var exports = function (apiClient) {
			...
			this.getBrowseNodesWithHttpInfo = function (getBrowseNodesRequest) {
				...
				if (
					getBrowseNodesRequest === undefined ||
					getBrowseNodesRequest === null
				) {
					throw new Error(
			...
			this.getBrowseNodes = function (getBrowseNodesRequest) {
				return this.getBrowseNodesWithHttpInfo(getBrowseNodesRequest).then(
			...
			this.getItems = function (getItemsRequest) {
				return this.getItemsWithHttpInfo(getItemsRequest).then(
					function (response_and_data) {
						return response_and_data.data;
					},
				);
			...
			this.getVariationsWithHttpInfo = function (getVariationsRequest) {
				...
				if (
					getVariationsRequest === undefined ||
					getVariationsRequest === null
				) {
					throw new Error(
			...
			this.getVariations = function (getVariationsRequest) {
				return this.getVariationsWithHttpInfo(getVariationsRequest).then(
					function (response_and_data) {
						return response_and_data.data;
					},
				);
			...
			this.searchItems = function (searchItemsRequest) {
				return this.searchItemsWithHttpInfo(searchItemsRequest).then(
					function (response_and_data) {
						return response_and_data.data;
					},
				);
